...
import com.xuanfeng.nzq.websocket.main.game.process.BeginMatchHandler;
...
//        chatHandlerManager.putAHandler(11,h11());
        ...
        chatHandlerManager.putAHandler(20,h20());
    ...
    @Bean
    public BeginMatchHandler h20() {
        return new BeginMatchHandler();
    }
